                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <select class="form-select" name="trang_thai">
                                                            ...
                                                            <option value="1" <?= is_array($danhMuc) && isset($danhMuc['trang_thai']) && $danhMuc['trang_thai'] === 1 ? 'selected' : '' ?>>Hiển thị</option>
<option value="2" <?= is_array($danhMuc) && isset($danhMuc['trang_thai']) && $danhMuc['trang_thai'] === 2 ? 'selected' : '' ?>>Không hiển thị</option>
