                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-striped table-nowrap align-middle mb-0">
                                                ...
                                                <?php foreach ($danhMucs as $danhMuc) : ?>
                                                    <tr>
                                                        <td class="fw-medium"><?= $danhMuc['id'] ?></td>
                                                        ...
                                                        <td>
                                                            <div class="hstack gap-3 flex-wrap">
                                                                <a href="?act=form-sua-danh-muc&danh_muc_id=<?= $danhMuc['id'] ?>"
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        function performSearch() {
            ...
            timeoutId = setTimeout(() => {
                fetch(`?act=search-danh-muc&search=${encodeURIComponent(searchTerm)}`)
                    ...
                    .then(data => {
                        ...
                        data.forEach((item) => {
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="hstack gap-3 flex-wrap">
                                        <a href="?act=form-sua-danh-muc&danh_muc_id=${item.id}" class="link-success fs-15"><i class="ri-edit-2-line"></i></a>
                                        <form action="?act=xoa-danh-muc" method="POST" onsubmit="return confirm('Bạn có đồng ý xóa không')">
                                            <input type="hidden" name="danh_muc_id" value="${item.id}">
