            ...
            <div class="wrapper-heading-home animation-tran container clearfix">
                <div class="col-md-8 col-md-offset-2 col-sm-8 col-sm-offset-2 col-xs-12">
                    <div class="site-animation">
                        <h2><a href="/product?show=new" class="tp_title"></a></h2>
                        <div class="seperate-icon"><img data-sizes="auto" class="lazyload" src="https://web.nvnstatic.net/img/lazyLoading.gif?v=3" data-src="https://web.nvnstatic.net/tp/T0295/img/seperate-icon.png?v=3"></div>
                    </div>
                </div>
            </div>
            <div class="container">
                <div class="row">
                    <?php foreach ($sanPhams as $index => $sanPham) : ?>
                        <div class="pro-loop animation-tran productItems product-ivt col-md-3 col-sm-4 col-xs-6" data-storeId="53936" data-id="39112440">
                            <div class="product-block product-resize site-animation" data-anmation="22">
                                <div class="product-img image-resize" data-product-id="39112440">
                                    <a href="?act=chitietsp&id=<?= $sanPham['id'] ?>" title="UMBR.O RAGLAN SWEATER">
                                        <picture>
                                            <img data-sizes="auto" class="img-loop img-default lazyload" alt="UMBR.O RAGLAN SWEATER" src="<?= $sanPham['hinh_anh'] ?>" data-src="<?= $sanPham['hinh_anh'] ?>" data-img="<?= $sanPham['hinh_anh'] ?>" />
                                        </picture>
                                    </a>
                                    <div class="button-add tp_button">
                                        <button onclick="location.href='?act=chitietsp&id=<?= $sanPham['id'] ?>'" title="Xem nhanh" class="action quick-view" data-id="39112440">
                                            <span>Xem nhanh</span>
                                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Capa_1" x="0px" y="0px" viewBox="0 0 59.2 59.2" style="enable-background:new 0 0 59.2 59.2;" xml:space="preserve">
                                                <g>
                                        ...
                                        <button title="Mua ngay" class="action add-to-cart" onclick="location.href='?act=chitietsp&id=<?= $sanPham['id'] ?>'"> <span>Mua ngay</span>
                                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Capa_1" x="0px" y="0px" width="27.948px" height="27.948px" viewBox="0 0 27.948 27.948" style="enable-background:new 0 0 27.948 27.948;" xml:space="preserve">
                                                <g>
                                ...
                                <div class="product-detail clearfix">
                                    <div class="box-pro-detail">
                                        <h3 class="pro-name">
                                            <a href="?act=chitietsp&id=<?= $sanPham['id'] ?>" title="UMBR.O RAGLAN SWEATER" class="tp_product_name">
