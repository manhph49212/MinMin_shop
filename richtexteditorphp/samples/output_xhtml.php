...
<body>
	<form action="output_xhtml.php" method="post" action="<?php echo htmlentities($_SERVER["PHP_SELF"]."?".$_SERVER["QUERY_STRING"])?>">
       <h1>
        ...
        <br/>
        <h3>XHTML:</h3>
		<textarea style="height:120px;width:760px;"><?php echo $rte->Text ?></textarea>
    </form>
</body>
</html>