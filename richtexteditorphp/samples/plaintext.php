...
<body>
	<form action="plaintext.php" method="post" action="<?php echo htmlentities($_SERVER["PHP_SELF"]."?".$_SERVER["QUERY_STRING"])?>">
       <h1>
        ...
        <br/>
        <h3>HTML:</h3>
		<textarea style="height:120px;width:760px;"><?php echo $editortext ?></textarea>
		<br />
		<h3>PlainText:</h3>
		<textarea style="height:120px;width:760px;"><?php echo $plaintext ?></textarea>
		<br />
		<h3>PlainText with line feeds:</h3>
		<textarea style="height:120px;width:760px;"><?php echo $plaintextlinefeeds ?></textarea>
    </form>
</body>
</html>