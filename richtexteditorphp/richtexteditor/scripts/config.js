...
window.RTE_Configuration =
{
	...
	googlemapkey:"AIzaSyDOKrFkitKj05EEfHc41GfnCDzIQEwcXcM",	//for google map https://developers.google.com/maps/documentation/javascript/get-api-key
	...
	default_code_table: "<table cellspacing='2' cellpadding='2' style='width:580px'></table>",	// default table attributes
	...
	fontnamelist: 'Arial,Verdana,Tahoma,Segoe UI,Sans-Serif,Comic Sans MS,Courier New,Georgia,Impact,Times New Roman',
	fontsizelist: '11px,12px,13px,14px,15px,16px,18px,20px,24px,36px',
