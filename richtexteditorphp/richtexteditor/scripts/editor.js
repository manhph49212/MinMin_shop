...
$rte.Editor=$rte.Core._extends(function(base,type){
	...
	this.ShowPropertiesDialogDefault=function(element,option)
	{
		...
		if(!option.height)option.height=450;
	...
	this.ExecInsertAnchor=function(anchor,tag)
	{
		...
		var option={width:360,height:250,targetnode:tag,anchor:anchor};
	...
	this.ExecInsertLink=function(anchor,tag)
	{
		...
		var option={width:580,height:450,targetnode:tag,anchor:anchor};
		this.ShowTagDialog(this.BuildDialogUrl("properties.xml"),option,sp,this.delegate(function()
		{
	...
	this.ExecInsertTemplate=function(anchor)
	{
		...
		var option={width:750,height:420,anchor:anchor};
...
//			tag.SetAttribute("href","http://")
		...
		var option={width:750,height:480,targetnode:tag,anchor:anchor,oktext:oktext};
	...
	this.ExecInsertVideo=function(anchor,img)
	{
		...
		if(img==null)
		{
			...
			img.SetStyle("width","680px");
			img.SetStyle("height","460px");
		...
		var option={width:680,height:480,targetnode:img,anchor:anchor};
	...
	this.ExecInsertImage=function(anchor,img)
	{
		...
		var option={width:800,height:550,targetnode:img,anchor:anchor,oktext:oktext};
	...
	this.ExecInsertGallery=function(anchor)
	{
		...
		var option = { width: 800, height: 550,targetnode:img,anchor:anchor};
		option.callback=this.delegate(function(res,err)
		{
			if(!res)
			{
	...
	this.ExecInsertImageMap=function(anchor,img)
	{
		...
		var option={width:640,height:400,targetnode:map,targetimg:img,anchor:anchor,oktext:oktext};
		option.callback=this.delegate(function(res,err)
		{
			if(!res)
			{
	...
	{
		var option={width:460,height:200};
	...
	{
		var option={width:590,height:330}
